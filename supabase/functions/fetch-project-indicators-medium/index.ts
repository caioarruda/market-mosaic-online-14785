...
serve(async (req) => {
  ...
  try {
    ...
    const response = await fetch(
      `https://api-support.hmg.agilean.com.br/api/v1/portal/global/project/${projectId}/indicators-medium-data`,
      {
        method: 'GET',
        headers: {
    ...
    console.error('Error in fetch-project-indicators-medium function:', error);
