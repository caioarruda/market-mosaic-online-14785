    ...
    <Card className="p-6 h-full flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-4 flex-1">
        <div className="flex flex-col justify-center items-center p-4 bg-primary/5 rounded-lg">
          ...
          <span className="text-sm text-muted-foreground">IDP - Índice de Desempenho de Prazo</span>
        ...
        <div className="flex flex-col justify-center items-center p-4 bg-primary/5 rounded-lg">
          ...
          <span className="text-sm text-muted-foreground">Desvio de Prazo</span>
          <span className="text-2xl font-bold">{data.delay} dias</span>
        </div>

        <div className="flex flex-col justify-center items-center p-4 bg-primary/5 rounded-lg">
          <DollarSign className="w-8 h-8 mb-2 text-primary" />
          <span className="text-sm text-muted-foreground">Custo Real Acumulado</span>
          <span className="text-xl font-bold">{formatCurrency(data.realValueAccum)}</span>
        </div>

        <div className="flex flex-col justify-center items-center p-4 bg-primary/5 rounded-lg">
          <DollarSign className="w-8 h-8 mb-2 text-primary" />
          <span className="text-sm text-muted-foreground">Custo Planejado Acumulado</span>
      ...
      <div className="flex items-center justify-between pt-4 border-t">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm">
            Variação de Avanço Físico: {formatPercentage(Math.abs(data.advanceDelta))}
          </span>
        </div>
      </div>
    </Card>
